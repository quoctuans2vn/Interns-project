    ...
    <header>
        ...
        <div class="container-fluid py-3 px-5" style="font-size: 0.875rem">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-sm-6 col-md-4 text-md-center">
        ...
        <!-- End Top header -->
        <!-- Bottom header -->
        <nav class="navbar navbar-expand-sm navbar-light py-3 px-lg-5" id="navbar-changebg" style="font-weight: 500;">
