...
<body>
    ...
    <div class="container-fluid px-xl-7 py-6">
        <div class="row">
            <div class="products-category col-lg-8 col-xl-9 order-lg-2">
                <!-- Hero content -->
                ...
                <!-- Breadcrumb -->
                <ol class="breadcrumb text-dark px-0">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>

                    <li class="breadcrumb-item active" aria-current="page">Shop</li>
                </ol>
                <!-- Producs category header -->
                <div class="products-category-header">
                    ...
                    <div class="mr-3 mb-3">
                        ...
                        <a href="#" class="products-category-header-show active">12</a>
                        <a href="#" class="products-category-header-show">24</a>
                        <a href="#" class="products-category-header-show">All</a>
                    </div>
                    <div class="mb-3">
                        <span class="mr-2">Sort by</span>
                        <select name="" id="" class="selectpicker" data-dropup-auto="true"
                            data-style="btn-selectpicker border-0" data-dropup-auto="false">
                ...
                <!-- Pagination  -->
                <nav aria-label="page pagination" class="mb-5 mt-3">
            ...
            <div class="sidebar col-lg-4 col-xl-3 order-lg-1">
                ...
                <div class="sidebar-block px-3 px-lg-0">
                    <a data-toggle="collapse" href="#categoriesMenu" role="button" aria-expanded="false"
                        aria-controls="categoriesMenu" class="d-lg-none narrow-rotate">Product Categories
                        <span class="footer-toggler-icon"></span>
                    </a>
                    <div id="categoriesMenu" class="expand-lg collapse">
                        <h5 class="sidebar-heading d-lg-block d-none">Category</h5>
                        <div class="sidebar-icon-menu mt-4 mt-lg-0">
                            <!-- Trousers -->
                            <div class="sidebar-icon-menu-item active" data-toggle="collapse" data-target="#subcate_0"
                                aria-expanded="true" aria-controls="subcate_0">
                                <div class="d-flex align-items-center">
                                    <img src="https://img.icons8.com/ios/50/000000/trousers.png" class="sidebar-icon"
                                        alt="" />
                                    <a href="#" class="sidebar-icon-menu-link font-weight-bold mr-2">Trousers</a>
                                    <span class="sidebar-icon-menu-count">120</span>
                                </div>
                                <div id="subcate_0" class="collapse show">
                                    <ul class="sidebar-icon-submenu">
                                        <li class="sidebar-icon-submenu-item">
                                            <a href="#"
                                                class="sidebar-icon-submenu-link link-footer text-hover-gold">Lorem
                                                ipsum</a>
                                        </li>
                                        <li class="sidebar-icon-submenu-item">
                                            <a href="#"
                                                class="sidebar-icon-submenu-link link-footer text-hover-gold">Dolor</a>
                                        </li>
                                        <li class="sidebar-icon-submenu-item">
                                            <a href="#"
                                                class="sidebar-icon-submenu-link link-footer text-hover-gold">Sit
                                                amet</a>
                                        </li>
                                        <li class="sidebar-icon-submenu-item">
                                            <a href="#"
                                                class="sidebar-icon-submenu-link link-footer text-hover-gold">Donec
                                                vitae</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <!-- Jackets -->
                            <div class="sidebar-icon-menu-item" data-toggle="collapse" data-target="#subcate_1"
                                aria-expanded="false" aria-controls="subcate_1">
                                <div class="d-flex align-items-center">
                                    <img src="https://img.icons8.com/ios/50/000000/jacket.png" class="sidebar-icon"
                                        alt="" />
                                    <a href="#" class="sidebar-icon-menu-link font-weight-bold mr-2">Jackets</a>
                                    <span class="sidebar-icon-menu-count">55</span>
                                </div>
                                <div id="subcate_1" class="collapse">
                                    <ul class="sidebar-icon-submenu">
                                        <li class="sidebar-icon-submenu-item">
                                            <a href="#"
                                                class="sidebar-icon-submenu-link link-footer text-hover-gold">Lorem
                            ...
                            <!-- T-Shirt -->
                            <div class="sidebar-icon-menu-item" data-toggle="collapse" data-target="#subcate_2"
                                aria-expanded="false" aria-controls="subcate_2">
                                <div class="d-flex align-items-center">
                                    <img src="https://img.icons8.com/cotton/50/000000/t-shirt--v4.png"
                                        class="sidebar-icon" alt="" />
                                    <a href="#" class="sidebar-icon-menu-link font-weight-bold mr-2">T-Shirts</a>
                                    <span class="sidebar-icon-menu-count">33</span>
                                </div>
                                <div id="subcate_2" class="collapse">
                                    <ul class="sidebar-icon-submenu">
                                        <li class="sidebar-icon-submenu-item">
                                            <a href="#"
                                                class="sidebar-icon-submenu-link link-footer text-hover-gold">Lorem
                ...
                <!-- Price -->
                <div class="sidebar-block px-3 px-lg-0">
                    <a data-toggle="collapse" href="#priceMenu" role="button" aria-expanded="false"
                        aria-controls="priceMenu" class="d-lg-none narrow-rotate">Filter by price
                        <span class="footer-toggler-icon"></span>
                    </a>
                    <div id="priceMenu" class="expand-lg collapse">
                        <h5 class="sidebar-heading d-none d-lg-block">Price </h5>
                        <div id="slider-snap" class="mt-4 mt-lg-0"> </div>
                        <div class="nouislider-values">
                            <div class="min">From $<span id="slider-snap-value-start"></span></div>
                            <div class="max">To $<span id="slider-snap-value-end"></span></div>
                            <input type="hidden" name="pricefrom" id="slider-snap-input-start" value="40"
                                class="slider-snap-input">
                            <input type="hidden" name="priceto" id="slider-snap-input-end" value="110"
                                class="slider-snap-input">
                        </div>
                    </div>
                </div>
                <!-- Brand -->
                <div class="sidebar-block px-3 px-lg-0">
                    <a data-toggle="collapse" href="#brandMenu" aria-expanded="true" aria-controls="brandMenu"
                        class="d-lg-none narrow-rotate">Filter by
                        brand<span class="footer-toggler-icon"></span></a>
                    <div id="brandMenu" class="expand-lg collapse show">
                        <h5 class="sidebar-heading d-none d-lg-block">Brands </h5>
                        <form action="#" class="mt-4 mt-lg-0">
                            <div class="form-check pl-0 mb-1">
                                <label class="form-check-label container px-4" for="brand0">Calvin Klein
                                    <small>(18)</small>
                                    <input class="check-box-custom" type="checkbox" id="brand0" name="clothes-brand"
                                        checked />
                                    <span class="check-mark"></span>
                                </label>
                            </div>
                            <div class="form-check pl-0 mb-1">
                                <label class="form-check-label container px-4" for="brand1">Levi Strauss
                                    <small>(30)</small>
                                    <input class="check-box-custom" type="checkbox" id="brand1" name="clothes-brand"
                                        checked />
                                    <span class="check-mark"></span>
                                </label>
                            </div>
                            <div class="form-check pl-0 mb-1">
                                <label class="form-check-label container px-4" for="brand2">Hugo Boss
                                    <small>(120)</small>
                                    <input class="check-box-custom" type="checkbox" id="brand2" name="clothes-brand" />
                                    <span class="check-mark"></span>
                                </label>
                            </div>
                            <div class="form-check pl-0 mb-1">
                                <label class="form-check-label container px-4" for="brand3">Tomi Hilfiger
                                    <small>(70)</small>
                                    <input class="check-box-custom" type="checkbox" id="brand3" name="clothes-brand" />
                                    <span class="check-mark"></span>
                                </label>
                            </div>
                            <div class="form-check pl-0 mb-1">
                                <label class="form-check-label container px-4" for="brand4">Tom Ford
                                    <small>(110)</small>
                                    <input class="check-box-custom" type="checkbox" id="brand4" name="clothes-brand" />
                                    <span class="check-mark"></span>
                                </label>
                            </div>
                        </form>
                ...
                <!-- Size -->
                <div class="sidebar-block px-3 px-lg-0">
                    <a data-toggle="collapse" href="#sizeMenu" aria-expanded="false" aria-controls="sizeMenu"
                        class="d-lg-none narrow-rotate">Filter by
                        size<span class="footer-toggler-icon"></span></a>
                    <!-- Size filter menu-->
                    <div id="sizeMenu" class="expand-lg collapse">
                ...
                <!-- Color filter menu -->
                <div class="sidebar-block px-3 px-lg-0">
                    <a data-toggle="collapse" href="#colourFilterMenu" aria-expanded="false"
                        aria-controls="colourFilterMenu" class="d-lg-none narrow-rotate">Filter by
                        colour<span class="footer-toggler-icon"></span></a>
                    <div id="colourFilterMenu" class="expand-lg collapse">
                        <h5 class="sidebar-heading d-none d-lg-block">Colour </h5>
                        <div class="mt-4 mt-lg-0">
                            <ul class="list-inline mb-0 colours-wrapper">
                                <li class="list-inline-item">
                                    <label for="blue" style="background-color: #668cb9" data-allow-multiple
                                        class="btn-colour"> </label>
                                    <input type="checkbox" name="colour" value="blue" id="blue" class="input-hide">
                                </li>
                                <li class="list-inline-item">
                                    <label for="white" style="background-color: #fff" data-allow-multiple
                                        class="btn-colour"> </label>
                                    <input type="checkbox" name="colour" value="white" id="white" class="input-hide">
                                </li>
                                <li class="list-inline-item">
                                    <label for="violet" style="background-color: #8b6ea4" data-allow-multiple
                                        class="btn-colour"> </label>
                                    <input type="checkbox" name="colour" value="violet" id="violet" class="input-hide">
                                </li>
                                <li class="list-inline-item">
                                    <label for="red" style="background-color: #dd6265" data-allow-multiple
                                        class="btn-colour"> </label>
                                    <input type="checkbox" name="colour" value="red" id="red" class="input-hide">
                                </li>
                            </ul>
                        </div>
                    </div>
