...
<body>
    ...
    <!-- Banner not Parallax -->
    <section class="parallax py-lg-6 py-5" style="background-color: transparent;">
        <div class="container">
            <!-- Breadcumbs -->
            ...
            <div class="hero-content">
                ...
                <div class="text-muted" style="font-weight: 500;">
                    <p>
                        <a href="#"><img src="./Image/avatar-1.jpg" class="w-2rem avatar-circle"
                                alt=""></a>
                        By
    ...
    <section id="comments" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-10 mx-auto">
                    <h6 class="text-uppercase mb-6 text-lg-right word-gold" style="font-size: 1.5rem; font-weight:800;">
                        2 comments</h6>
                    <!-- comment -->
                    <div class="row mb-4">
                        <div class="col-3 col-md-2 text-center">
                            <p>
                                <img class="avatar-circle img-fluid" src="./Image/avatar-1.jpg"
                                    alt="" />
                            </p>
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-3 col-md-2 text-center">
                            <p>
                                <img class="avatar-circle img-fluid" src="./Image/avatar-2.jpg"
                                    alt="" />
                            </p>
                        </div>
                        <div class="col-9 col-md-10">
