...
<body>
    ...
    <header class="header-absolute">
        <!-- Top header -->
        <div class="container-fluid navbar-transparent py-3 px-lg-5" style="font-size: 0.875rem">
    ...
    <div class="container-fluid pb-3 px-lg-5 pt-5 px-3">
        <div class="row justify-content-between">
            ...
            <div class="col-12 col-sm-4 text-sm-right text-center pl-0"><a href="#" class="text-uppercase word-gold">ALL
                    PRODUCTS</a></div>
        </div>
    </div>
    <!-- 12 Item -->
