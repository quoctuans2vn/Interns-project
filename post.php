...
<body>
    ...
    <!-- Banner not Parallax -->
    <section class="parallax" style="background-color: transparent;">
        <div class="container">
            <!-- Breadcumbs -->
            <ol class="breadcrumb text-dark">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>

                <li class="breadcrumb-item" aria-current="page"><a href="blog.html">Blog</a></li>
                <li class="breadcrumb-item active" aria-current="page">Fashion, purpose & freedom</li>
            </ol>
            <!-- Hero content -->
            <div class="hero-content">
                <h1 class="hero-heading">Fashion, purpose & freedom</h1>
                <div class="text-muted" style="font-weight: 500;">
                    <p>By
                        <b><a href="#" class="text-reset">John Slim</a></b> &#9474;
                        January 16, 2016 in
                        <b style="color: #bcac76;"><a href="#" class="text-gold">Fashion</a></b> &#9474;
                        <a href="#" class="text-reset">2 comments</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-11 mx-auto">
                    <img src="https://images.pexels.com/photos/934064/pexels-photo-934064.jpeg?cs=srgb&dl=bracelets-clothes-earrings-934064.jpg&fm=jpg"
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-10 mx-auto">
                    <div class="mb-5">
                        <p class="lead">As am hastily invited settled at limited civilly fortune me. Really spring in
                            extent an by. Judge but built party world. Of so am he remember although required. Bachelor
                    ...
                    <div class="text-content">
                        ...
                        <div class="pt-2">
                            <img class="img-fluid mb-2"
                                src="https://images.pexels.com/photos/2829173/pexels-photo-2829173.png?cs=srgb&dl=beautiful-beauty-casual-2829173.jpg&fm=jpg"
                                alt="" />
                            <div class="text-center text-gray">
                                Photo by Jack Tran, New York
                            </div>
                        </div>
                        <h2 class="mb-4">Header Level 2</h2>
                        <ol class="text-gray mb-4 py-2">
                            <li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</li>
                            <li>Aliquam tincidunt mauris eu risus.</li>
                        </ol>
                        <div class="border-gold-left py-3 mb-3">
                        ...
                        <p class="text-gray mb-4">Pellentesque habitant morbi tristique senectus et netus et malesuada
                            ...
                            id cursus faucibus, tortor neque egestas augue, eu vulputate magna eros eu erat. Aliquam
                            erat volutpat. Nam dui mi, tincidunt quis, accumsan porttitor, facilisis luctus, metus</p>
                        <h4 class="pt-2 mb-4">A nice list here</h4>
                        <ul class="pt-2 text-gray list-unstyled pl-2">
                            <li><i class="fas fa-chevron-right"></i> Lorem ipsum dolor sit amet, consectetuer adipiscing
                                elit.</li>
                            <li><i class="fas fa-chevron-right"></i> Aliquam tincidunt mauris eu risus.</li>
                            <li><i class="fas fa-chevron-right"></i> Nam dui mi, tincidunt quis, accumsan porttitor,
                                facilisis luctus, metus</li>
                            <li><i class="fas fa-chevron-right"></i> Aenean fermentum, elit eget tincidunt condimentum,
                                eros ipsum rutrum orci.</li>
                        </ul>
                        <!-- Image -->
                        <div class="py-3 mb-3">
                            <img class="img-fluid"
                                src="https://images.pexels.com/photos/590415/pexels-photo-590415.jpeg?cs=srgb&dl=attractive-beautiful-beauty-590415.jpg&fm=jpg"
                                alt="">
                        </div>
                        <p class="text-gray mb-4">Pellentesque habitant morbi tristique senectus et netus et malesuada
                            fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit
    ...
    <section class="py-5">
        <div class="container">
            <h3 class="font-weight-bold text-center mb-5" style="font-size: 2rem;">You may also like</h3>
            <div class="row mb-5">
    ...
    <section id="comments" class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-10 mx-auto">
                    <h6 class="text-uppercase mb-6 text-lg-right word-gold h4" style="font-weight:800;">2 comments</h6>
                    <!-- comment -->
                    <div class="row mb-4">
                        <div class="col-3 col-md-2 text-center">
                            <p>
                                <img class="avatar-circle img-fluid" src="Image/beautiful-casual-city-1812888.jpg"
                                    alt="" />
                            </p>
                        </div>
                        <div class="col-9 col-md-10">
                            <h5 style="font-weight: 700">Julie Alma</h5>
                            <p class="text-uppercase text-sm text-muted mb-4" style="letter-spacing: 0.15em;">
                            ...
                            <p>
                                <a href="#" class="btn btn-comment-gold text-uppercase" style="font-size: 0.8rem;"><i
                    ...
                    <div class="row mb-4">
                        <div class="col-3 col-md-2 text-center">
                            <p>
                                <img class="avatar-circle img-fluid" src="Image/adult-blank-book-bindings-698928.jpg"
                                    alt="" />
                            </p>
                        </div>
                        <div class="col-9 col-md-10">
                            <h5 style="font-weight: 700">Louise Armero</h5>
                            <p class="text-uppercase text-sm text-muted mb-4" style="letter-spacing: 0.15em;">
                                <i class="far fa-clock"></i>
                            ...
                            <p class="text-gray mb-4">
                                ...
                                eleifend leo. Pellentesque habitant morbi tristique senectus et netus et malesuada fames
                                ac turpis egestas.
                            </p>
                            <p>
                                <a href="#" class="btn btn-comment-gold text-uppercase" style="font-size: 0.8rem;"><i
                    ...
                    <form action="#" method="get" class="my-5">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-4 form-underlined">
                                    <label for="nameComment" class="form-label-custom">Name *
                                    </label>
                                    <input type="text" class="form-control search-box-custom" name="nameComment"
                                        id="nameComment" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-4 form-underlined">
                                    <label for="emailComment" class="form-label-custom">Email *
                                    </label>
                                    <input type="text" class="form-control search-box-custom" name="emailComment"
                                        id="emailComment" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-4 form-underlined">
                            <label for="commentComment" class="form-label-custom">Comment *</label>
                            <textarea class="form-control search-box-custom" name="commentComment" id="commentComment"
                                rows="4"></textarea>
                        </div>
                        <button type="submit" class="btn btn-slide btn-outline-warning text-uppercase mt-3">Leave
                            comment</button>
                    </form>
                </div>
            </div>
